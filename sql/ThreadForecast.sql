...
SELECT thread_id
 ...
 SELECT ThreadForecast.
   FROM ThreadForecast
   LEFT JOIN Contacts	ON Contacts_id = ThreadForecast.supplier_id
   LEFT JOIN Threads	ON Thread_id   = ThreadForecast.thread_id
   LEFT JOIN Controls	ON Controls.Thread_id   = ThreadForecast.thread_id
