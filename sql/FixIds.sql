...
UPDATE NextIds SET next_id = 	 7	WHERE table_name = 'BatchOuts'		;
UPDATE NextIds SET next_id = 	 7	WHERE table_name = 'BatchSets'		;
UPDATE NextIds SET next_id = 	 1	WHERE table_name = 'Boxes'			;
UPDATE NextIds SET next_id = 	 5	WHERE table_name = 'CheckOuts'		;
UPDATE NextIds SET next_id =  3100	WHERE table_name = 'Colors'			;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'Comments'		;
UPDATE NextIds SET next_id =   225	WHERE table_name = 'Configs'	 	;
UPDATE NextIds SET next_id =   107	WHERE table_name = 'Contacts'	 	;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'Controls'		;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'Cylinders'		;
UPDATE NextIds SET next_id = 	 1	WHERE table_name = 'Emails'			;
...
UPDATE NextIds SET next_id =  1291	WHERE table_name = 'History'		;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'Incomings'		;
UPDATE NextIds SET next_id =   	48	WHERE table_name = 'JKY_Users'	  	;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'LoadOuts'	  	;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'LoadQuotations'	;
...
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'NFEItems'		;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'NFEs'			;
UPDATE NextIds SET next_id =   	 4	WHERE table_name = 'Orders'			;
UPDATE NextIds SET next_id =   	 2	WHERE table_name = 'OrdThreads'		;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'OSAs'			;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'OSA_Lines'		;
UPDATE NextIds SET next_id =   	14  WHERE table_name = 'Permissions'	;
UPDATE NextIds SET next_id =   	 1  WHERE table_name = 'Pieces'			;
UPDATE NextIds SET next_id =   	 1  WHERE table_name = 'ProdPrices'		;
UPDATE NextIds SET next_id =  1293	WHERE table_name = 'Products'		;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'PurchaseLines'	;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'PurchaseMonthly';
...
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'ReceiveDyers'  	;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'Recipes'	  	;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'ReqLines'	  	;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'Requests'	  	;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'Restrictions'  	;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'Sales'		  	;
...
UPDATE NextIds SET next_id =     1	WHERE table_name = 'ThreadForecast'	;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'ThreadJoined'	;
...
#	DL
UPDATE NextIds SET next_id =  1542	WHERE table_name = 'Batches'		;
UPDATE NextIds SET next_id =  3259	WHERE table_name = 'BatchOuts'		;
UPDATE NextIds SET next_id =  2945	WHERE table_name = 'BatchSets'		;
UPDATE NextIds SET next_id = 79888	WHERE table_name = 'Boxes'			;
UPDATE NextIds SET next_id =  2863	WHERE table_name = 'CheckOuts'		;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'Colors'			;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'Comments'		;
UPDATE NextIds SET next_id =    84	WHERE table_name = 'Configs'	 	;
UPDATE NextIds SET next_id =    25	WHERE table_name = 'Contacts'	 	;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'Controls'		;
UPDATE NextIds SET next_id =   101	WHERE table_name = 'Cylinders'		;
UPDATE NextIds SET next_id = 	 1	WHERE table_name = 'Emails'			;
UPDATE NextIds SET next_id =   678	WHERE table_name = 'FTPs'			;
UPDATE NextIds SET next_id =  1089	WHERE table_name = 'FTP_Loads'		;
UPDATE NextIds SET next_id =  3323	WHERE table_name = 'FTP_Sets'		;
UPDATE NextIds SET next_id =  1279	WHERE table_name = 'FTP_Threads'	;
UPDATE NextIds SET next_id =168175	WHERE table_name = 'History'		;
UPDATE NextIds SET next_id =  1355	WHERE table_name = 'Incomings'		;
UPDATE NextIds SET next_id =   	14	WHERE table_name = 'JKY_Users'	  	;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'LoadOuts'	  	;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'LoadQuotations'	;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'LoadSales'	  	;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'LoadSets'	  	;
...
UPDATE NextIds SET next_id =   	 1  WHERE table_name = 'Pieces'			;
UPDATE NextIds SET next_id =   	 1  WHERE table_name = 'ProdPrices'		;
UPDATE NextIds SET next_id =   243	WHERE table_name = 'Products'		;
UPDATE NextIds SET next_id =   518	WHERE table_name = 'PurchaseLines'	;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'PurchaseMonthly';
UPDATE NextIds SET next_id =   201	WHERE table_name = 'Purchases'		;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'Quotations'		;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'QuotColors'		;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'QuotLines'		;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'ReceiveDyers'  	;
...
UPDATE NextIds SET next_id =     1	WHERE table_name = 'ThreadForecast'	;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'ThreadJoined'	;
UPDATE NextIds SET next_id =   397	WHERE table_name = 'Threads'		;
UPDATE NextIds SET next_id =   119	WHERE table_name = 'Tickets'		;
UPDATE NextIds SET next_id =     1 	WHERE table_name = 'Translations'	;
...
UPDATE NextIds SET next_id =   438	WHERE table_name = 'Controls'		;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'Cylinders'		;
UPDATE NextIds SET next_id = 	 1	WHERE table_name = 'Emails'			;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'FTPs'			;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'FTP_Loads'		;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'FTP_Sets'		;
UPDATE NextIds SET next_id =     1	WHERE table_name = 'FTP_Threads'	;
UPDATE NextIds SET next_id =  1320	WHERE table_name = 'History'		;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'Incomings'		;
...
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'OSAs'			;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'OSA_Lines'		;
UPDATE NextIds SET next_id =   109	WHERE table_name = 'Permissions'	;
UPDATE NextIds SET next_id =   	 1  WHERE table_name = 'Pieces'			;
UPDATE NextIds SET next_id =   	 1  WHERE table_name = 'ProdPrices'		;
...
UPDATE NextIds SET next_id =     1	WHERE table_name = 'Threads'		;
UPDATE NextIds SET next_id =   	 1	WHERE table_name = 'Tickets'		;
UPDATE NextIds SET next_id =  1761	WHERE table_name = 'Translations'	;
