...
--
-- Host: localhost
-- Generation Time: Apr 24, 2013 at 04:49 AM
...
CREATE TABLE IF NOT EXISTS `controls` (
  ...
  KEY `sequence` (`company_id`,`sequence`),
  KEY `name` (`name`,`sequence`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1000000272 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1000000000698 ;
