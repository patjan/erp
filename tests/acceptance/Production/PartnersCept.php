...
$I->wantTo			('test Partners page');
$I->login			($I, 'Production', 'User');

$I->clickMenu		($I, 'Production');
$I->clickBar		($I, 'Production', 'Partners');

$I->clickSelect		($I, 'All'		);
$I->clickSelect		($I, 'Inactive'	);
$I->clickSelect		($I, 'Active'	);

$I->clickActionForm	($I, 'ADT');
$I->canSeeInField	('#jky-nick-name'		, 'ADT');
$I->canSeeInField	('#jky-full-name'		, 'Dital Malharia Ltda');
