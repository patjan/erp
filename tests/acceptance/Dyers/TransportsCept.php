...
$I->wantTo			('test Transports page');
$I->login			($I, 'Dyers', 'User');

$I->clickMenu		($I, 'Dyers');
$I->clickBar		($I, 'Dyers', 'Transports');

$I->clickSelect		($I, 'All'		);
$I->clickSelect		($I, 'Inactive'	);
$I->clickSelect		($I, 'Active'	);

$I->clickActionForm	($I, 'Propria');
$I->canSeeInField	('#jky-nick-name'		, 'propria');
$I->canSeeInField	('#jky-full-name'		, 'propria');
