...
JKY.generate_row = function(the_row) {
	...
	var my_html = ''
		...
		+ '<td ><input  class="jky-batch-average_weight"	text="text"								 disabled="disabled" value="' + the_row.average_weight	+ '" /></td>'
		+ '<td ><input  class="jky-batch-requested_boxes"	text="text"								 disabled="disabled" value="' + the_row.requested_boxes	+ '" /></td>'
		+ '<td ><input  class="jky-batch-requested_weight"	text="text" onchange="JKY.update_batch(this, ' + my_id + ')" value="' + the_row.requested_weight+ '" /></td>'
