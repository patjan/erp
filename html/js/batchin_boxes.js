...
//	var my_print = (the_row.labels_printed >= the_row.received_boxes) ? '' : '<a onclick="JKY.Batch.display(this, ' + my_id + ')"><i class="icon-print"></i></a>';
	...
	var my_html = ''
		...
		+ '<td ><input  class="jky-boxes-batch-number"		disabled value="' + JKY.fix_null(the_row.batch_number	)	+ '" /></td>'
		+ '<td ><input  class="jky-boxes-barcode"			disabled value="' + JKY.fix_null(the_row.batch	)			+ '" /></td>'
		+ '<td ><input  class="jky-boxes-number-of-boxes"	disabled value="' + JKY.fix_null(the_row.batch	)			+ '" /></td>'
		+ '<td ><input  class="jky-boxes-number-of-cones"	disabled value="' + the_row.received_boxes					+ '" /></td>'
		+ '<td ><input  class="jky-boxes-average-weight"	disabled value="' + the_row.labels_printed					+ '" /></td>'
		+ '<td ><input  class="jky-boxes-real-weight"		disabled value="' + the_row.number_of_cones					+ '" /></td>'
		+ '<td ><input  class="jky-boxes-checkin-location"	disabled value="' + the_row.received_weight					+ '" /></td>'
		+ '<td ><input  class="jky-boxes-checkout-location"	disabled value="' + the_row.unit_price						+ '" /></td>'
		+ '</tr>'
		;
	return my_html;
}
