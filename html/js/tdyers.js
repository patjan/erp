...
JKY.set_table_row = function(the_row) {
	var my_html = ''
		...
		+  '<td class="jky-needed-date"		>' + JKY.short_date	(the_row.needed_date		)	+ '</td>'
		+  '<td class="jky-checkout-date"	>' + JKY.short_date	(the_row.checkout_date		)	+ '</td>'
		+  '<td class="jky-returned-date"	>' + JKY.short_date	(the_row.returned_date		)	+ '</td>'
