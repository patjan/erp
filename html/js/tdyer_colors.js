...
//	var my_trash = (the_row.order_id == null) ? '<a onclick="JKY.delete_color(this, ' + my_id + ')"><i class="icon-trash"></i></a>' : '';
	...
	var my_html = ''
		...
		+ '<td class="jky-color-value"	><input class="jky-ordered-weight"	onchange="JKY.update_color(this, ' + my_id + ')" value="' +				 the_row.ordered_weight	  + '" /></td>'
		+ '<td class="jky-color-value"	><input class="jky-checkout-weight"	onchange="JKY.update_color(this, ' + my_id + ')" value="' +				 the_row.checkout_weight  + '" disabled="disable" /></td>'
		+ '<td class="jky-color-value"	><input class="jky-needed-date"		onchange="JKY.update_color(this, ' + my_id + ')" value="' + JKY.out_date(the_row.needed_at		) + '" /></td>'
		+ '<td class="jky-color-value"	><input class="jky-checkout-date"	onchange="JKY.update_color(this, ' + my_id + ')" value="' + JKY.out_date(the_row.checkout_at	) + '" disabled="disable" /></td>'
		+ '</tr>'
		;
	return my_html;
}
