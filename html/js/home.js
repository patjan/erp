...
//		$('#jky-planning-reqlines'		).click (function() {JKY.process_action('reqlines'			);});
		...
		$('#jky-production-schedules'	).click (function() {JKY.process_action('schedules'			);});
...
//		$('#jky-pieces-info'			).click (function() {JKY.process_action('pieces_info'		);});
		...
		$('#jky-receiving-not-received'	).click (function() {JKY.process_action('fabrics_not_received');});
		$('#jky-receiving-return'		).click (function() {JKY.process_action('fabrics_return'	);});
		$('#jky-receiving-reprocess'	).click (function() {JKY.process_action('fabrics_reprocess'	);});
		$('#jky-receiving-scrap'		).click (function() {JKY.process_action('fabrics_scrap'		);});
		$('#jky-receiving-counters'		).click (function() {JKY.process_action('fabric_counters'	);});

		$('#jky-fabrics-checkin'		).click (function() {JKY.process_action('fabrics_checkin'	);});
		$('#jky-fabrics-saleout'		).click (function() {JKY.process_action('fabrics_saleout'	);});
//		$('#jky-fabrics-info'			).click (function() {JKY.process_action('fabrics_info'		);});
		$('#jky-fabrics-label'			).click (function() {JKY.process_action('fabrics_label'		);});
		$('#jky-fabrics-shipout'		).click (function() {JKY.process_action('fabrics_shipout'	);});

		$('#jky-accounts-customers'		).click (function() {JKY.process_action('customers'			);});
		$('#jky-accounts-invoices'		).click (function() {JKY.process_action('invoices'			);});
		$('#jky-accounts-receivables'	).click (function() {JKY.process_action('receivables'		);});
...
JKY.process_start_page = function() {
	...
	var my_menus =
		...
		,{id:'jky-menu-accounts'	, icon:'plus', label:'Accounts'		}
...
JKY.process_menu = function(menu) {
	...
	switch(menu) {
		case 'jky-menu-sales'		: JKY.show('jky-side-sales'		); JKY.process_action('sales'			); break;
...
//		case 'jky-menu-purchases'	: JKY.show('jky-side-purchases'	); JKY.process_action('purchases'		); break;
		case 'jky-menu-production'	: JKY.show('jky-side-production'); JKY.process_action('schedules'		); break;
		...
		case 'jky-menu-accounts'	: JKY.show('jky-side-accounts'	); JKY.process_action('invoices'		); break;
