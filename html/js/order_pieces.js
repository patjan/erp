...
JKY.display_pieces = function() {
	var my_data =
		...
		, table		: 'Pieces'
		, select	:  JKY.row.id
		, order_by  : 'Pieces.created_at DESC'
		};
...
//	var my_trash = (the_row.batch_id == null) ? '<a onclick="JKY.delete_pieces(this, ' + my_id + ')"><i class="icon-trash"></i></a>' : '';
	var my_trash = '<a onclick="JKY.delete_pieces(this, ' + my_id + ')"><i class="icon-trash"></i></a>';
	var my_pieces = ''
	...
	var my_batchin = ''
		...
		+ "<input class='jky-batchin-row-batch' readonly='readonly' onclick='JKY.update_pieces(this, " + my_id + ")' value='" + the_row.batch_number + "' />"
