...
JKY.set_form_row = function(the_row) {
	...
	JKY.set_value	('jky-template-body'	,				 the_row.template_body	);
	JKY.set_value	('jky-template-sql'		,				 the_row.template_sql	);
...
JKY.get_form_set = function() {
	var my_set = ''
		...
		+    ', template_body=\'' + JKY.get_value	('jky-template-body'	) + '\''
		+     ', template_sql=\'' + JKY.get_value	('jky-template-sql'		) + '\''
